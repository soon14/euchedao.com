...
if(is_array($row))
{
   ...
   $row['price']=!empty($row['lineprice'])?"<span class=\"rmb_1\">￥</span>".$row['lineprice']."</span>":"价格对VIP会员开放</span>";
...
{/sline:field.piclist}
************/
function getPiclistArrZ($piclist,$isda=1,$bigtemp=' <li><img src="{src}" width="600" height="auto"/></li>',$thumbtemp=' <li><s></s><img src="{src}" width="96" height="65"/></li>',$replacetemp='{src}')
{
  $num=0;
